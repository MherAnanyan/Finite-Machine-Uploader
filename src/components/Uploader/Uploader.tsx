...
export const Uploader = () => {
  ...
  const [machineState, sendToStateMachine] = useMachine(
    FileUploadMachine,
    {
      actions: {
        uploadFiles: async () => {
  ...
  const isResetDisabled =
    ...
    machineState.value === 'UPLOADING';
  const isRetryDisabled =
    machineState.value !== 'CANCELED' &&
    machineState.value !== 'FAILED';
